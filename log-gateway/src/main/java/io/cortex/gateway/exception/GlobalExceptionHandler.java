    ...
    private static HttpStatus mapStatus(final ErrorCodes code) {
        return switch (code) {
            ...
            case UPSTREAM_UNAVAILABLE, NL_QUERY_UPSTREAM_FAILED, SEARCH_LOGS_UPSTREAM_FAILED,
                    GET_LOG_BY_ID_UPSTREAM_FAILED, GET_ANOMALIES_UPSTREAM_FAILED ->
                    HttpStatus.BAD_GATEWAY;
            case RATE_LIMITED, NL_QUERY_RATE_LIMITED, SEARCH_LOGS_RATE_LIMITED,
                    GET_LOG_BY_ID_RATE_LIMITED, GET_ANOMALIES_RATE_LIMITED ->
                    HttpStatus.TOO_MANY_REQUESTS;
            case NL_QUERY_INVALID, NL_QUERY_REFUSED, SEARCH_LOGS_INVALID, GET_ANOMALIES_INVALID ->
