 ...
 * Source of truth is the inbound {@code X-Request-Id} header; if absent,
 * a UUID is generated. The value is echoed back as the same response
 * header so callers can correlate.</p>
 *
 * <p>Runs as the highest-precedence filter so every downstream
 * component sees the id in MDC.</p>
 */
@Component
