...
/**
 * HTTP scrape configuration for the P8.7+ OTel span-metric SLO
 * backend.
 *
 ...
 */
@Validated
@ConfigurationProperties(prefix = "cortex.monitoring.slo.otel")
public record OtelSloProperties(Duration requestTimeout, String actuatorPath) {
