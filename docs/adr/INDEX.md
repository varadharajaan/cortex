...
Last refreshed: 2026-06-08 (P8.0 log-monitoring-service scaffold + `ServiceHealthProbe` SPI + per-backend probe contract, PR for #111).
Total ADRs: 44 (`0000` template + `0001` .. `0027` + `0029` + `0030` + `0031` + `0032` + `0033` + `0034` + `0035` + `0036` + `0037` + `0038` + `0039` + `0040` + `0041` + `0042` + `0043` + `0044`).
