...
Last refreshed: 2026-06-07 (P7.2 log-indexer-service `applyRetention` via Quickwit Delete API, PR for #102).
Total ADRs: 40 (`0000` template + `0001` .. `0027` + `0029` + `0030` + `0031` + `0032` + `0033` + `0034` + `0035` + `0036` + `0037` + `0038` + `0039` + `0040`).
