...
Last refreshed: 2026-06-07 (P8.1 log-monitoring-service `EurekaActuatorHealthProbe` HTTP probe via Eureka discovery + dual-timeout `RestClient`, PR for #113).
Total ADRs: 45 (`0000` template + `0001` .. `0027` + `0029` + `0030` + `0031` + `0032` + `0033` + `0034` + `0035` + `0036` + `0037` + `0038` + `0039` + `0040` + `0041` + `0042` + `0043` + `0044` + `0045`).
