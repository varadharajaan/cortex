...
Last refreshed: 2026-06-08 (P7.1a log-indexer-service cross-phase closer + `@Lazy` bean-creation cycle fix on `QuickwitHttpAdmin` + `QuickwitHttpSearch`, PR for #109).
Total ADRs: 43 (`0000` template + `0001` .. `0027` + `0029` + `0030` + `0031` + `0032` + `0033` + `0034` + `0035` + `0036` + `0037` + `0038` + `0039` + `0040` + `0041` + `0042` + `0043`).
