...
Last refreshed: 2026-06-07 (P7.3 log-indexer-service per-tenant cardinality budgets via `ensureIndex(spec, budget)`, PR for #105).
Total ADRs: 41 (`0000` template + `0001` .. `0027` + `0029` + `0030` + `0031` + `0032` + `0033` + `0034` + `0035` + `0036` + `0037` + `0038` + `0039` + `0040` + `0041`).
